...
|------|--------|----------|---------------|
| 2026-08-11 | BMS | 代收货款类费项（FEE0022/FEE0023/FEE0024，按费项编码清单维护）原币改为目的国币种 `dest_country_currency_code`（详见多币种计费设计） | - |
...
8. 代收货款类费项（FEE0022 代收货款、FEE0023 代收货款手续费、FEE0024 到付金额，清单见
   `BmsConstants.FEE_CODES_SOURCE_CURRENCY_DEST_COUNTRY`）按目的国币种收取，费用原币取源单
   `dest_country_currency_code`。
