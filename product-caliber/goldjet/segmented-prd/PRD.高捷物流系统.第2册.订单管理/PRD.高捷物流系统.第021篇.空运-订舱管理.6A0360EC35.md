...
| 提单属性 | 自营/非自营；必填。 |
| 提单号、同行名称 | 自营展示自动绑定的提单号及修改入口；非自营提供同行名称、提单号录入位置。提单号绑定和修改沿用[订单异常与修改规则](PRD.高捷物流系统.第020篇.空运-订单创建.5029269CA8.md#doc-5029269CA8-section-9983c813182e)，同行名称的来源与校验尚未明确。 |
