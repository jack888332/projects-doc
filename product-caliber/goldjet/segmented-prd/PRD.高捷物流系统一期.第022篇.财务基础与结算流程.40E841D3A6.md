...
| 财务会计 | 审批结算费用；<br>审批调整单；<br>审批付款申请；<br>创建收款申请；<br>确认收款申请；<br>创建销项票申请；<br>手工补录销项票；<br>审核合作方新增档案；<br>审核客户授信额度。 |
...
- **区域级通用规则**：字段均只读；仅展示当前公司下的银行账户，按查询条件筛选，未设置查询条件时展示该公司全部记录。
