...
3. 客户从集运客门户下载账单时，必须使用[面向客户的对账报表导出](PRD.账单系统.第017篇.账单导出.29F2A66D22.md#doc-29F2A66D22-notification-export-4e42db1e)生成客户对账文件。面向财务的内部导出文件不得在集运客门户提供查看或下载。
...
4. 如邮件包含附件，附件必须使用[面向客户的对账报表导出](PRD.账单系统.第017篇.账单导出.29F2A66D22.md#doc-29F2A66D22-notification-export-4e42db1e)生成的客户对账文件，并遵循客户可见信息规则；[面向财务的对账报表导出](PRD.账单系统.第017篇.账单导出.29F2A66D22.md#doc-29F2A66D22-notification-export-6fedb811)生成的内部文件不得作为客户邮件附件。
