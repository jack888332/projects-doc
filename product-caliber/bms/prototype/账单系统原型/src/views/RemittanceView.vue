...
<template>
  <div class="module-page">
    <PageHeader eyebrow="COD COLLECTION" title="回款管理"><template #actions><el-checkbox v-model="showFx" border>查看汇兑损益</el-checkbox></template></PageHeader>
    ...
    <section class="module-panel">
      ...
      <el-table :data="rows" class="clean-table" row-key="tracking">
