...
4. 费项结算币种读取客户级账单配置已经保存的结果；默认汇率命中按[账单生成命中与快照](PRD.账单系统.第006篇.客户级汇率配置.72D3AF6045.md#doc-72D3AF6045-rate-config-42cd9f89)执行，金额换算按[汇率与金额换算](PRD.账单系统.第014篇.金额汇兑.27B80EF314.md#doc-27B80EF314-currency-exchange-d860ed63)执行。
