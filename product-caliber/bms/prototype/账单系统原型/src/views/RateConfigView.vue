...
import { Check, Delete, Download, EditPen, Plus, Search } from '@element-plus/icons-vue'
...
<template>
  <div class="module-page">
    <PageHeader eyebrow="EXCHANGE RATES" title="汇率配置">
      <template #actions><el-button :icon="Download" @click="simpleAction('导入任务')">导入基准汇率</el-button><el-button disabled>抓取</el-button><el-button type="primary" :icon="Plus" @click="simpleAction('新增汇率')">{{ activeTab === 'base' ? '添加基准汇率' : '添加客户特调' }}</el-button></template>
    </PageHeader>
    ...
    <section class="module-panel">
      ...
      <el-table v-if="activeTab === 'base'" :data="rows" class="clean-table">
