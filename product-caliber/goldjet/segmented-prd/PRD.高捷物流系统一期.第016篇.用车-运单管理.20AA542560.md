...
- P2：终点仅连接已取消运单，不表示费用处理结束；已卸货运单仍允许上报异常，因此不将已卸货连接生命周期终点。图中未展开异常状态；异常期间允许继续履约，异常恢复见[异常管理规则](#doc-20AA542560-section-19313adccda8)。异常上报、取消资格及返空费按[逆向流程节点说明](#doc-20AA542560-section-731d67f1818c)处理；中转运单的初始状态按[中转运单列表规则](#doc-20AA542560-section-9bdf355a4f45)处理。
