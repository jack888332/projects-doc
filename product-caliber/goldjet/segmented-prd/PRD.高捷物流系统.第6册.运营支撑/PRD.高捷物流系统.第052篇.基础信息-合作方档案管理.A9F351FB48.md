...
**概念模型：** [数据字典 · 合作方与报价实体](PRD.高捷物流系统.第061篇.数据字典.7A3D9E1F50.md#doc-7A3D9E1F50-domain-partners-quotes)
...
供应商、客户和授信额度的跨场景稳定属性、关系与受控取值见[数据字典 · 合作方与报价实体](PRD.高捷物流系统.第061篇.数据字典.7A3D9E1F50.md#doc-7A3D9E1F50-domain-partners-quotes)；各页面使用的字段组合、必填和编辑规则以本篇对应场景为准。

<a id="doc-A9F351FB48-section-5a7ec1bdc1a9"></a>
#### 1.1.4 参与角色与职责

参与角色为业务、业务主管和财务；操作授权见[基础资料与报价操作权限](PRD.高捷物流系统.第062篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-foundation-actions)。
...
供应商列表的查询角色与数据范围见[基础资料与报价数据范围](PRD.高捷物流系统.第062篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-foundation-scope)。本页面提供供应商新增、供应商查看、供应商编辑、供应商删除、供应商提交审批、供应商失效、供应商生效、供应商审批入口；各入口的操作权限和业务条件分别按权限篇与下述场景执行。
...
- 保存：保存该供应商，校验必填字段。保存成功自动生成供应商编码。规则：“S+5位流水”，不改变该供应商的状态。字段定义见 [数据字典 · 供应商金蝶编码映射](PRD.高捷物流系统.第061篇.数据字典.7A3D9E1F50.md#doc-7A3D9E1F50-mappings-mapping-partner-kingdee-code)。
...
提交审批和审批拒绝后的通知按[消息推送规则](PRD.高捷物流系统.第064篇.消息推送.5F950AB3B1.md#doc-5F950AB3B1-section-ef4930471a81)发送。
...
客户列表的查询角色与数据范围见[基础资料与报价数据范围](PRD.高捷物流系统.第062篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-foundation-scope)。本页面提供客户新增、查看、编辑、删除、提交审批、失效、启用、审批及授信额度申请、审批入口；角色授权见[基础资料与报价操作权限](PRD.高捷物流系统.第062篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-foundation-actions)，业务条件按下述场景执行。
...
- 保存：保存该客户，校验必填字段。保存成功自动生成客户编码。规则：“C+5位流水”，不改变该客户的状态。字段定义见 [数据字典 · 客户金蝶编码映射](PRD.高捷物流系统.第061篇.数据字典.7A3D9E1F50.md#doc-7A3D9E1F50-mappings-mapping-partner-kingdee-code)。
...
客户及授信额度的查询范围见[基础资料与报价数据范围](PRD.高捷物流系统.第062篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-foundation-scope)；额度申请与审批的角色授权见[授信额度操作权限](PRD.高捷物流系统.第062篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-foundation-actions)。
