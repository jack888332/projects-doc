...
| 区域 | 字段 / 操作 | 说明 |
| :--- | :--- | :--- |
| 操作区 | `查看汇兑损益` | 展示或隐藏按锁定快照计算的汇兑损益字段，具体金额口径见<a href="#section-15">15. 金额汇兑</a>。 |
...
4. `查看汇兑损益` 打开时，页面展示的损益字段应保持与回款 / 返款锁定快照一致，不随市场汇率刷新；异常签收行和同币种行是否展示，按<a href="#section-15">15. 金额汇兑</a>处理。
