...
var _hoisted_14 = { transform: "translate(34.500000, 31.500000) scale(-1, 1) rotate(-25.000000) translate(-34.500000, -31.500000) translate(7.000000, 10.000000)" };
...
var img_empty_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props) {
    ...
    const id = useId();
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", _hoisted_1, [createBaseVNode("defs", null, [
        ...
        createBaseVNode("linearGradient", {
          ...
          "stop-color": `var(${unref(ns).cssVarBlockName("fill-color-1")})`,
          offset: "0%"
        }, null, 8, _hoisted_6), createBaseVNode("stop", {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", { class: normalizeClass(unref(ns).b()) }, [
        ...
        }, null, 8, _hoisted_110)) : renderSlot(_ctx.$slots, "image", { key: 1 }, () => [createVNode(img_empty_default)])], 6),
        createBaseVNode("div", { class: normalizeClass(unref(ns).e("description")) }, [_ctx.$slots.description ? renderSlot(_ctx.$slots, "description", { key: 0 }) : (openBlock(), createElementBlock("p", _hoisted_24, toDisplayString(emptyDescription.value), 1))], 2),
...
//# sourceMappingURL=chunk-ISTJH3ZY.js.map
