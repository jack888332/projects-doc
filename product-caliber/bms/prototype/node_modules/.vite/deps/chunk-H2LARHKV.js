...
var useCheckboxStatus = (props, slots, { model }) => {
  ...
  const isChecked = computed(() => {
    ...
    else if (isArray(value)) if (isObject(actualValue.value)) return value.map(toRaw).some((o) => isEqual_default(o, actualValue.value));
...
//# sourceMappingURL=chunk-H2LARHKV.js.map
