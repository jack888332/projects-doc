...
| 字段或控件特例 | 特例约束或业务结果 |
| --- | --- |
| 客户订单号 | 去重校验；[按订单来源确定维护状态](PRD.高捷物流系统一期.第015篇.用车-订单管理.32C78B8106.md#doc-32C78B8106-section-e810f2381097)；选填。 |
...
| 供应商名称 | 支持修改选择；默认选择规则见[用车订单业务规则](PRD.高捷物流系统一期.第015篇.用车-订单管理.32C78B8106.md#doc-32C78B8106-section-a943dda32b46)；必填；默认值：显示默认公司；可编辑。 |
