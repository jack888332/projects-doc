...
**关联模块流程：** [仓单订单外部对接流程](PRD.高捷物流系统一期.第033篇.DDP跨模块作业与结算流程.7579B595B8.md#doc-7579B595B8-section-e1cba7e91d25)、[货站打板流程](#doc-B42F0635C9-section-e7bebd79575e)、[打板订单管理流程](#doc-B42F0635C9-section-b937bb7ae261)。
...
| 系统 | 一级菜单 | 二级菜单 | 说明 |
| --- | --- | --- | --- |
| 高捷物流平台 | 订单管理 | 打板订单管理 | 打板订单列表与详情；访问角色见[地面业务页面访问](PRD.高捷物流系统一期.第035篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-entry)。 |
...
打板服务形成订单，货站到达与板纸提交分别回写作业节点，托书和货站重量用于后续费用处理。
...
步骤 10 使用步骤 2 维护的打板费单价。单价由货站在报价管理独立维护，不要求每个订单重新维护报价。
...
1. 状态管理：角色授权见[地面业务操作权限](PRD.高捷物流系统一期.第035篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)。点击操作列中的“状态”按钮修改打板订单状态，规则与航晟物流运输运单的“状态管理”功能一致。
