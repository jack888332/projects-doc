...
- **区域字段或业务元素**：付款申请批次号、结算单位、应收应付周期、状态、税额合计、不含税总金额、申请总金额、申请币种、创建日期、创建人、备注、附件、审批意见、税务发票号、发票类型、开票日期、发票含税金额、币种、税率、开票税率、未税金额、订单号、客户、订单创建人、业务日期、订单行号、成本项目、税率(%)、数量、计费单位、含税单价(原币)、金额(原币)、提单号、已申请金额(原币)、可申请金额(原币)、本次申请金额(原币)。
...
- **区域字段或业务元素**：付款申请批次号、结算单位、应收应付周期、状态、税额合计、不含税金额合计、申请金额合计、申请币种、创建日期、创建人、备注、附件、审批意见、税务发票号、发票类型、开票日期、发票含税金额、币种、税率、开票税率、未税金额、订单号、客户、订单创建人、业务日期、订单行号、成本项目、税率(%)、数量、计费单位、含税单价(原币)、总金额(原币)、提单号、已申请金额(原币)、可申请金额(原币)、本次申请金额(原币)。
...
| 字段或控件特例 | 适用条件 | 特例约束或业务结果 |
| --- | --- | --- |
| 订单号 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的订单号。 |
| 客户 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的订单客户。 |
| 订单创建人 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的订单创建人。 |
| 业务日期 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的业务日期。 |
| (子)单号 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的(子)单号。 |
| 结算单位 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的结算单位。 |
| 成本项目 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的成本项目。 |
| 成本属性 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的成本项目；待付款申请界面，默认值展示成本属性为“应收”的数据。 |
| 税率(%) |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的税率。 |
| 数量 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的数量。 |
| 计费单位 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的计费单位。 |
| 含税单价(原币) |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的含税单价(原币)。 |
| 总金额(原币) |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的总金额(原币)。 |
| 币种 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的币种。 |
| 提单号 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的提单号。部分订单无提单号。 |
| 备注 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的备注。 |
| 已申请金额(原币) |  | 系统自动生成；汇总范围见[收付款申请金额计算规则](PRD.高捷物流系统一期.第026篇.财务结算-收付款申请管理.C548DF1D48.md#doc-C548DF1D48-section-a4c8d210fe73)。 |
| 可申请金额(原币) |  | 系统自动生成；计算规则见[收付款申请金额计算规则](PRD.高捷物流系统一期.第026篇.财务结算-收付款申请管理.C548DF1D48.md#doc-C548DF1D48-section-a4c8d210fe73)。 |
...
| 状态 |  | 自动生成；创建付款申请时，状态默认为“新建”；进行“保存时”。 |
| 税额合计、不含税金额合计、申请金额合计 |  | 付款申请保存后自动生成；[计算规则见收付款申请金额计算规则](PRD.高捷物流系统一期.第026篇.财务结算-收付款申请管理.C548DF1D48.md#doc-C548DF1D48-section-a4c8d210fe73)。 |
...
| 已申请金额(原币) |  | 系统自动生成；汇总范围见[收付款申请金额计算规则](PRD.高捷物流系统一期.第026篇.财务结算-收付款申请管理.C548DF1D48.md#doc-C548DF1D48-section-a4c8d210fe73)。 |
| 可申请金额(原币) |  | 系统自动生成；计算规则见[收付款申请金额计算规则](PRD.高捷物流系统一期.第026篇.财务结算-收付款申请管理.C548DF1D48.md#doc-C548DF1D48-section-a4c8d210fe73)。 |
| 本次申请金额(原币) |  | 默认值与校验规则见[收付款申请金额计算规则](PRD.高捷物流系统一期.第026篇.财务结算-收付款申请管理.C548DF1D48.md#doc-C548DF1D48-section-a4c8d210fe73)；可编辑；必填；有默认值。 |
...
| 开票税率、未税金额 |  | 提交后由系统自动生成；计算规则见[付款申请发票补录](PRD.高捷物流系统一期.第026篇.财务结算-收付款申请管理.C548DF1D48.md#doc-C548DF1D48-section-0243192953b1)。 |
...
| 主业务流程 | 勾选“勾选界面明细”数据，进入付款申请新增页面，分别输入：备注、税务发票号、发票类型、开票日期、发票含税金额、税率、本次申请金额(原币)。<br>备注：<br>- 非必填；<br>- 文本格式，手工录入备注；<br>- 未保存前，可修改备注。<br>附件上传<br>- 非必填；<br>- 可点击查看，手工上传附件（图片、文档、PDF，限制大小为20M）；<br>- 未保存前，可删除重新上传附件。<br>税务发票号：<br>- 必填；<br>- 文本格式；<br>- 未保存前，可修改。<br>发票类型：<br>- 必填；<br>- 文本格式，从候选项中选择，候选列表展示2列（普通发票和专用发票）；<br>- 未保存前，可修改)。<br>开票日期：<br>- 必填；<br>- 日期格式；<br>- 未保存前，可修改。<br>发票含税金额：<br>- 必填；<br>- 文本格式；<br>- 未保存前，可修改。<br>点击“保存”进行提交保存，弹出保存确认弹框。<br>- 确认：显示“保存成功”提示，跳转到“待付款申请列表”界面，该付款申请状态变为“新建”。<br>- 无法提交：若必填项未输入，则该输入项红色高亮提示，保存按钮置灰不可点击。若本次申请金额(原币)>可申请金额(原币)，也无法保存成功。<br>- 取消保存，调整至“付款申请新增”界面，再次编辑付款申请。<br>点击“保存并提交”进行提交保存，弹出提交确认弹框。<br>- 确认：显示“提交成功”提示，跳转到“待付款申请列表”界面，该付款申请状态变为“已提交”。<br>- 无法提交：若必填项未输入，则该输入项红色高亮提示，保存按钮置灰不可点击。若本次申请金额(原币)>可申请金额(原币)，也无法保存成功。<br>- 取消提交，调整至“付款申请新增”界面，再次编辑付款申请。 |
...
- **区域字段或业务元素**：收款申请批次号、结算单位、应收应付周期、状态、税额合计、不含税总金额、申请总金额、申请币种、创建日期、创建人、备注、审批意见、附件、收款银行、收款账户名称、收款银行账号、订单号、客户、订单创建人、业务日期、订单行号、成本项目、税率(%)、数量、计费单位、含税单价(原币)、总金额(原币)、币种、提单号、已申请金额(原币)、可申请金额(原币)、本次申请金额(原币)。
...
- **区域字段或业务元素**：收款申请批次号、结算单位、应收应付周期、状态、税额合计、不含税金额合计、申请金额合计、申请币种、创建日期、创建人、备注、附件、审批意见、收款银行、收款账户名称、收款银行账号、订单号、客户、订单创建人、业务日期、订单行号、成本项目、税率(%)、数量、计费单位、含税单价(原币)、总金额(原币)、币种、提单号、已申请金额(原币)、可申请金额(原币)、本次申请金额(原币)。
...
| 结算单位 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的结算单位。 |
| 成本项目 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的成本项目。 |
| 成本属性 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的成本项目；待收款申请界面，默认值展示成本属性为“应收”的数据。 |
| 税率(%) |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的税率。 |
| 数量 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的数量。 |
| 计费单位 |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的计费单位。 |
| 含税单价(原币) |  | 来源：财务审批通过、对账完成的“结算明细”和“调整单明细”的含税单价(原币)。 |
...
| 应收应付周期 |  | 自动生成；根据结算单位，在客户表中查找对应的应收应付周期。 |
| 状态 |  | 自动生成；创建收款申请时，状态默认为“新建”；进行“保存时”。 |
| 税额合计、不含税金额合计、申请金额合计 |  | 收款申请保存后自动生成；[计算规则见收付款申请金额计算规则](PRD.高捷物流系统一期.第026篇.财务结算-收付款申请管理.C548DF1D48.md#doc-C548DF1D48-section-a4c8d210fe73)。 |
...
| 主业务流程 | 勾选“勾选界面明细”数据，进入收款申请新增页面，分别输入：备注、收款账号、本次申请金额(原币)。<br>1. 备注：<br>- 非必填；<br>- 文本格式，手工录入备注；<br>- 未保存前，可修改备注。<br>1. 附件上传<br>- 非必填；<br>- 可点击查看，手工上传附件（图片、文档、PDF，限制大小为20M）；<br>- 未保存前，可删除重新上传附件。<br>1. 收款账号：<br>- 非必填；<br>- 字符格式，从候选项中选择，候选列表展示3列（收款账号、收款银行、收款账户名称）；<br>- 未保存前，可修改银行，可选择空值。<br>1. 本次申请金额(原币)：<br>- 必填；<br>- 数字格式，默认等于“可申请金额(原币)”；<br>- 未保存前，可修改本次申请金额(原币)。<br>每页显示50行明细数据，支持翻页查看明细数据。<br>点击“保存”进行提交保存，弹出保存确认弹框。<br>- 确认：显示“保存成功”提示，跳转到“待收款申请列表”界面，该收款申请状态变为“新建”。<br>- 无法提交：若必填项未输入，则该输入项红色高亮提示，保存按钮置灰不可点击。若本次申请金额(原币)>可申请金额(原币)，也无法保存成功。<br>- 取消保存，调整至“收款申请新增”界面，再次编辑收款申请。<br>点击“保存并提交”进行提交保存，弹出提交确认弹框。<br>- 确认：显示“提交成功”提示，跳转到“待收款申请列表”界面，该收款申请状态变为“已提交”。<br>- 无法提交：若必填项未输入，则该输入项红色高亮提示，保存按钮置灰不可点击。若本次申请金额(原币)>可申请金额(原币)，也无法保存成功。<br>- 取消提交，调整至“收款申请新增”界面，再次编辑收款申请。 |
