...
> 本篇定位：陆运-运单管理；主要内容：运单状态、轨迹、应收应付、异常与中转；文档角色：模块档；文档ID：20AA542560
...
**关联模块流程：** [运单管理流程](#doc-20AA542560-section-df85abad663f)、[中转仓用车流程](../PRD.高捷物流系统.第01册.需求框架/PRD.高捷物流系统.第011篇.DDP跨模块作业与结算流程.7579B595B8.md#doc-7579B595B8-section-e4cd43033ac4)。
...
管理员、客服的运单操作授权见[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)；各操作的状态条件和处理结果按本篇对应场景执行。
...
| 异常上报 | 运单状态不为“已取消”时可上报异常；上报角色按[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)执行。 |  |
...
1. “状态管理”按钮：用于人工更新运单状态，角色授权见[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)。
...
**专项规则：** 后台“状态管理”的角色授权见[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)；系统不校验轨迹事件的节点顺序。
...
**业务结果：** 异常记录显示准确，后台上报与取消异常形成对应记录；角色授权见[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)。
...
1. “取消异常”的角色授权见[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)。取消后异常关闭，运单从“异常中”恢复为发生异常前的状态。

- 备注：可选，长度为 2～500 个字符。

- 取消异常后，运单的“轨迹记录”页签生成取消异常记录。

**分支与边界：** 运单异常状态会同步影响所属订单状态，订单状态规则见[用车订单状态定义](PRD.高捷物流系统.第038篇.陆运-用车订单管理.32C78B8106.md#doc-32C78B8106-section-22c036104a98)。
...
**业务结果：** 单据按类型和更新时间展示；新增单据与杂费审批形成对应记录。角色授权见[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)。
...
| 应收、应付车型 | 应收与应付采用的车型可以不同；分别调整车型的角色授权见[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)。 |
| 人工杂费 | 手工录入杂费的角色授权见[地面业务操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第066篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-ground-actions)。 |
