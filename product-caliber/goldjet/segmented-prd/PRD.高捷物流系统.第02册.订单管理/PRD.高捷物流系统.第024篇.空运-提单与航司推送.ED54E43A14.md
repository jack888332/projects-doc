...
综合订单使用的总运单资料见[综合总运单与分单资料](PRD.高捷物流系统.第014篇.综合总运单与分单资料.0B2997FBF5.md#doc-0B2997FBF5-general-waybill-records)。
...
| 用户角色 | 描述 |
| --- | --- |
| 客服 | 操作授权见[提单操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第067篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-air-actions)。 |
| 打单员 | 操作授权见[提单操作权限](../PRD.高捷物流系统.第08册.运营支撑/PRD.高捷物流系统.第067篇.角色与访问权限.5E31456F30.md#doc-5E31456F30-air-actions)。 |
| 报关员 | 对该票货物报关 |
| 司机 | 把提单等资料交到柜台 |
...
司机将货站托运书交给航站楼打单员，供打单员填写提单的体积明细、毛重、件数、杂费和公布运价。打单员填写提单明细后，查看客服与航线人员留下的转关要求、报关行电话、随机文件及上传文件要求，核实报关是否完成、是否需要转关及另附纸质文件；报关和转关的后续处理按下表执行。
...
| 7 | 客服分重 | 客服 | 客服依据仓库称重结果提供各分单重量，用于随机文件、航司系统录入和按分单结算。 | 8 |  | 线下流程 |
...
| 16 | 打印提单 | 打单员 | 预览并打印提单及所需随机文件，交给司机。 | 17 |  | 系统流程 |
| 17 | 司机交单 | 司机 | 司机将打单员交付的提单及随机文件交到航司柜台，并在司机端小程序点击“交单”。 |  |  | 系统流程 |
