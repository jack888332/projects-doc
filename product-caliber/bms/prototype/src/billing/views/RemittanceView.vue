...
<template>
  <div class="module-page">
    <PageHeader><template #actions><el-checkbox v-model="showFx" border>查看汇兑损益</el-checkbox></template></PageHeader>
    ...
    <section class="module-panel filter-table-panel">
      <div class="table-reference-toolbar"><span>{{ rows.length }} 个尾程包裹</span></div>
