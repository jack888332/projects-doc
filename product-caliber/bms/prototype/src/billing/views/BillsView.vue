...
const bills = useDemoDataset('billingBills', [
  { type: 'AR', billNo: 'ARB-OG0271-20260731-81FF', status: '待审核', customer: '渣渣辉3号', customerNo: 'OG0271', memberCode: '700127', shop: '星际货运(中转)', country: '台湾', sector: '默认业务板块', periodType: '日', periodStart: '2026/07/31', periodEnd: '2026/07/31', sentAt: '2026/08/03', dueAt: '2026/08/03', overdueDays: 0, notice: '已通知', currency: 'CNY', amount: 68, paid: 0, secondCurrency: 'TWD', secondAmount: -721 },
  ...
  { type: 'RF', billNo: 'PCB-OG0347-20260526', status: '待结清', customer: '测试1', customerNo: 'OG0347', memberCode: '20260228-002', shop: '星际中转2', country: 'TW', periodType: '半周', periodStart: '2026/05/26', periodEnd: '2026/05/29', sentAt: '2026/05/30', refundMode: '回款返款', currency: 'TWD', original: 9780, deduction: 0, amount: 9780, paid: 2101, baseRefundable: 41076, baseReturned: 8824.2 },
  { type: 'RF', billNo: 'PCB-OG0370-20260721', status: '待审核', customer: 'JYK-深圳立杰海快', customerNo: 'OG0370', memberCode: '20260701-009', shop: '星际中转2', country: 'TW', periodType: '周', periodStart: '2026/07/21', periodEnd: '2026/07/27', sentAt: '-', refundMode: '签收返款', currency: 'CNY', original: 91640, deduction: 3020, amount: 88620, paid: 0 },
])
...
<template>
  <div class="module-page live-reference-page">
    ...
    <el-drawer v-model="detailVisible" size="86%" class="detail-drawer module-drawer" :close-on-click-modal="false">
      ...
      <BillDetailPanel v-if="selectedBill" :bill="selectedBill" :is-receivable="isReceivable" @action="action" />
    </el-drawer>
  </div>
</template>
