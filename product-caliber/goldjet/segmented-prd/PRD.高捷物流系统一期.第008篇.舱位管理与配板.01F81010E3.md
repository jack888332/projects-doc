...
1. 航线部员工进入此页面时，列表默认筛选出与该员工绑定的航线产品。若对航司代码进行“全部”筛选，显示全部产品。按照创建时间进行排序，优先显示最新创建时间。
...
| 周期日 | 选项：周一、周二、周三、周四、周五、周六、周日；编辑联动见[舱位产品维护约束](PRD.高捷物流系统一期.第008篇.舱位管理与配板.01F81010E3.md#doc-01F81010E3-section-93a33c11519b)；必填；可编辑。 |
| 板型 | 取自基础数据；必填。 |
| 基准载重、数量 | 正整数即可；选填。 |
...
5. 仅航线运营可编辑备注，且只能编辑本人在舱位产品管理页面维护的产品。其他航线运营需先被设置为该产品的航线运营，方可编辑备注。
